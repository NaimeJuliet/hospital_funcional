...
namespace Hospital
{
    ...
    public partial class formulario_Cita : System.Web.UI.Page
    {
        ...
        protected void Limpiar()
        {
            ...
            ButtonNombrePaciente.Text = "Consultar";
            ButtonNombreMedico.Text = "Consultar";
        }
        protected void Activar()
        {
            TextBoxCodigoCita.Enabled = true;
        ...
        protected void Desactivar() {
            TextBoxCodigoCita.Enabled = false;
            ...
            TextBoxAcompañante.Enabled = false;
            TextBoxActivo.Enabled = false;
            ButtonNombrePaciente.Enabled = false;
            ButtonNombreMedico.Enabled = false;
        ...
        protected void ButtonNombreMedico_Click(object sender, EventArgs e)
        {
            ...
            {
                TextBoxIdMedico.Text = "No se ha digitado la identificacion del medico";
        ...
        public bool verificacionPaciente() {
            DataSet paciente = new DataSet();

            oEntidadMedico.Id_medico = TextBoxIdMedico.Text;
            paciente = oReglasNegocioMedico.Consultar_Medico(oEntidadMedico);

            if (paciente.Tables[0].Rows.Count == 0)
            {
                return false;
        ...
        public bool verificacionDoctor() {


            DataSet doctor = new DataSet();

            oEntidadMedico.Id_medico = TextBoxIdMedico.Text;
            doctor = oReglasNegocioMedico.Consultar_Medico(oEntidadMedico);

            if (doctor.Tables[0].Rows.Count == 0)
            {
                return false;
            }
            else
        ...
        */
        protected void ButtonNombrePaciente_Click(object sender, EventArgs e)
        {
            ...
            {
                TextBoxIdPaciente.Text = "No se ha Digitado id del paciente";
        ...
        protected void TextBoxIdPaciente_TextChanged(object sender, EventArgs e)
        {
